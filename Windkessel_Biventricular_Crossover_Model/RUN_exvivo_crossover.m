...
addpath Core
addpath ExVivo_crossover

n_cores = 4; 

%% Choose experiment to run

% Make sure to run Healthy state first, before diseased state.
% This model focuses on LVSD, other disease states can be re-added
% similarly to Kim et al. 2023 model.

% run_experiment = 'Healthy';
run_experiment = {'Healthy', 'LVSD'}; 
...
if strcmp('Healthy',run_experiment)
    ...
    plot_exvivo_crossover_healthyonly(loading)
    ...
    plot_exvivo_crossover_healthymodsev(loading,data)
end
